...
var BluetoothHciSocket = null //requir('bluetooth-hci-socket');
...
Hci.prototype.readLocalVersion = function() {
  console.log("GYU # readLocalVersion");
  var cmd = new Buffer(4);
...
Hci.prototype.setAdvertisingParameters = function() {
  console.log("GYU # setAdvertisingParameters");
...
Hci.prototype.processCmdCompleteEvent = function(cmd, status, result) {
  ...
  if (cmd === RESET_CMD) {
    ...
    if (hciVer < 0x06) {
      ...
      console.log("GYU # got READ_LOCAL_VERSION_CMD on processOnCompleteCmd");
    ...
    console.log('GYU # got LE_SET_ADVERTISING_DATA_CMD on processOnCompleteCmd');
